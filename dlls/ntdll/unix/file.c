                                ...
                                REPARSE_DATA_BUFFER *buffer )
{
    ...
    nt_path_slen = wcslen(nt_path);
    nt_full_target.MaximumLength = nt_target.Length + (nt_path_slen + 1) * sizeof(WCHAR);
    ...
    free( nt_path );
    memcpy( &nt_full_target.Buffer[nt_path_slen], nt_target.Buffer, nt_target.Length );
    nt_full_target.Length = nt_path_slen * sizeof(WCHAR) + nt_target.Length;
